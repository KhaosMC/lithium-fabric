...
public class BlockEntityList implements List<BlockEntity> {
    ...
    private void throwException(BlockEntity blockEntity) {
        throw new IllegalStateException("Lithium BlockEntityList" + (this.posMap != null ? " with posMap" : "") + ": Adding the same BlockEntity object twice: " + blockEntity.writeNbt(new CompoundTag()));
    }
